...
const locales = {
    zh: {
        ...
        description: "多乐 Dolores 的个人网站：AI 产品、ClawChip AI 录音设备、小程序与网页实验、周周黑客松社群、生活与创作。",
        ogLocale: "zh_CN",
        jobTitle: "AI 产品人",
        schemaDescription: "AI 产品人，ClawChip AI Recorder 联合创始人，周周黑客松社群主理人。",
        nav: ["关于", "生活", "项目", "AI 框架", "留言"],
        hero: {
            lead: "做 AI 产品，也认真创造和生活。",
            body: "ClawChip AI Recorder 联合创始人，万人 AI 社群周周黑客松社群主理人，前互联网大厂出海业务产品 / 项目经理。香港中文大学（深圳）金融硕士。",
        ...
        projects: {
            ...
            clawchipTitle: "ClawChip AI Recorder",
            clawchipSummary: "一款配有电子墨水屏的便携 AI 录音设备，把语音内容转化为清晰可见的下一步行动。",
            clawchipPoints: [
                "我做了产品定义、概念表达和对外呈现。",
            ...
            clawchipPosterAlt: "ClawChip AI Recorder 吸附在手机背面的产品图",
            clawchipPrototypeAlt: "手指按下 ClawChip AI Recorder 录音键的产品图",
    ...
    en: {
        ...
        description: "Dolores Su's personal website: AI products, ClawChip AI Recorder, playful web experiments, Hackathon Weekly, life, and creative work.",
        ogLocale: "en_US",
        jobTitle: "AI Product Builder",
        schemaDescription: "AI product builder, co-founder of ClawChip AI Recorder, and Hackathon Weekly community builder.",
        nav: ["About", "Life", "Projects", "AI Framework", "Guestbook"],
        hero: {
            lead: "I build AI products—and take creating and living seriously.",
            body: "Co-founder of ClawChip AI Recorder and community lead of Hackathon Weekly, an AI community with more than 10,000 members. Former product and project manager for global businesses at major internet companies. MSc in Finance from CUHK-Shenzhen.",
        ...
        projects: {
            ...
            clawchipTitle: "ClawChip AI Recorder",
            clawchipSummary: "A pocket AI recorder with a quiet e-paper display that turns what you say into a visible next step.",
            clawchipPoints: [
            ...
            clawchipPosterAlt: "ClawChip AI Recorder attached to the back of a phone",
            clawchipPrototypeAlt: "A fingertip pressing the record button on ClawChip AI Recorder",
    ...
    es: {
        ...
        description: "Sitio personal de Dolores Su: productos de IA, la grabadora con IA ClawChip, experimentos web, Hackathon Weekly, vida y creación.",
        ogLocale: "es_ES",
        jobTitle: "Creadora de productos de IA",
        schemaDescription: "Creadora de productos de IA, cofundadora de la grabadora con IA ClawChip y responsable de Hackathon Weekly.",
        nav: ["Perfil", "Vida", "Proyectos", "Marco de IA", "Mensajes"],
        hero: {
            lead: "Creo productos de IA y me tomo en serio tanto crear como vivir.",
            body: "Cofundadora de la grabadora con IA ClawChip y responsable de Hackathon Weekly, una comunidad de IA con más de 10.000 miembros. Anteriormente trabajé como product y project manager en negocios globales de grandes empresas tecnológicas. Máster en Finanzas por CUHK-Shenzhen.",
        ...
        projects: {
            ...
            clawchipTitle: "Grabadora con IA ClawChip",
            clawchipSummary: "Una grabadora de bolsillo con pantalla de tinta electrónica que convierte lo que dices en un siguiente paso visible.",
            ...
            clawchipPosterAlt: "Grabadora con IA ClawChip acoplada a un teléfono",
            clawchipPrototypeAlt: "Un dedo pulsando el botón de grabación de ClawChip",
    ...
    pt: {
        ...
        description: "Site pessoal de Dolores Su: produtos de IA, o gravador com IA ClawChip, experimentos web, Hackathon Weekly, vida e criação.",
        ogLocale: "pt_BR",
        jobTitle: "Criadora de produtos de IA",
        schemaDescription: "Criadora de produtos de IA, cofundadora do gravador com IA ClawChip e líder da Hackathon Weekly.",
        nav: ["Sobre", "Vida", "Projetos", "Framework de IA", "Mensagens"],
        hero: {
            lead: "Crio produtos de IA e levo a sério tanto criar quanto viver.",
            body: "Cofundadora do gravador com IA ClawChip e líder da Hackathon Weekly, uma comunidade de IA com mais de 10 mil membros. Ex-product/project manager em negócios globais de grandes empresas de tecnologia. Mestre em Finanças pela CUHK-Shenzhen.",
        ...
        projects: {
            ...
            clawchipTitle: "Gravador com IA ClawChip",
            clawchipSummary: "Um gravador de bolso com tela e-paper que transforma o que você diz em um próximo passo visível.",
            ...
            clawchipPosterAlt: "Gravador com IA ClawChip acoplado a um celular",
            clawchipPrototypeAlt: "Um dedo pressionando o botão de gravação do ClawChip",
    ...
    fr: {
        ...
        description: "Site personnel de Dolores Su : produits IA, l’enregistreur IA ClawChip, expériences web, Hackathon Weekly, vie et création.",
        ogLocale: "fr_FR",
        jobTitle: "Créatrice de produits IA",
        schemaDescription: "Créatrice de produits IA, cofondatrice de l’enregistreur IA ClawChip et responsable de Hackathon Weekly.",
        nav: ["À propos", "Vie", "Projets", "Cadre IA", "Messages"],
        hero: {
            lead: "Je crée des produits IA, tout en prenant la création et la vie au sérieux.",
            body: "Cofondatrice de l’enregistreur IA ClawChip et responsable de Hackathon Weekly, une communauté IA de plus de 10 000 membres. Ancienne product/project manager pour des activités internationales de grandes entreprises tech. Master en finance de CUHK-Shenzhen.",
        ...
        projects: {
            ...
            clawchipTitle: "Enregistreur IA ClawChip",
            clawchipSummary: "Un enregistreur de poche avec écran e-paper qui transforme ce que vous dites en une prochaine étape visible.",
            ...
            clawchipPosterAlt: "Enregistreur IA ClawChip fixé au dos d’un téléphone",
            clawchipPrototypeAlt: "Un doigt appuyant sur le bouton d’enregistrement de ClawChip",
            ...
            <section class="projects section-grid" id="projects">
                ...
                <article class="project-card project-feature">
                    ...
                    <div class="project-media project-clawchip">
                        <img class="card-shot" src="${prefix}assets/clawchip-hero.webp" alt="${locale.projects.clawchipPosterAlt}" width="768" height="768" loading="eager" decoding="async">
                        <img class="floating-shot" src="${prefix}assets/clawchip-press.webp" alt="${locale.projects.clawchipPrototypeAlt}" width="960" height="960" loading="eager" decoding="async">
                    </div>
                </article>
